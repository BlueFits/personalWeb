    ...
    const about = {
        ...
        description: (
            <TextLoop noWrap={false} interval={aboutAnim}>
                <p>One of my favourite works of literature is “Keys To Success” by B.C. Forbes.</p>
                <p>
                    ...
                    <div onScroll={onScrollHandler} className="greeters-container">
                        <FadeIn transitionDuration={700}>
                            ...
                            <Greeters 
                                ...
                                header="Welcome"
                                text={<p>This is my personal website, want to know something about me?</p>}
                            />
                            <Greeters 
                                style={styles.textSpacing}
                                header={about.header}
                            ...
                            <Greeters 
                                style={styles.textSpacing}
                                header="Contact me"
                                text={<p>Back in 2014 I made a deccision to stay away from social
                                media, ever since then I use my social media strictly for
                                work. You can find me here.</p>}
